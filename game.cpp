...
int generateRandomNumber(int n) //generates random integer number for computer's turn
{
  srand(time(NULL)); //to make use of the computer's internal clock to control the choice of the seed 
  return rand() % n;
}
